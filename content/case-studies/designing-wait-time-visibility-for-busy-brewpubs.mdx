  ...
  - showDivider: true
    ...
    media:
      - type: image
        ...
        caption: "live wait-time overview that shows current wait time as a range\_\L(not an exact number), a simple crowd-level indicator and contextual helper text."
        alt: Case study 1
        layout: full
      - type: image
        image: /uploads/img/cs-2.jpg
        caption: "Once a guest decides the wait is worth it, the next question becomes:\_\LHow do I actually hold my spot?"
        alt: Case study 2
        layout: full
      - type: image
        image: /uploads/img/cs-3.jpg
        caption: "You’re in. Now\_what? One number. One range. That’s all it takes to shift a guest \Lfrom anxious to at ease."
        alt: Case study 3
        layout: full
      - type: image
